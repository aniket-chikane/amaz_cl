	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><img style = "height : 30px"alt="Amazon logo" src="./images/amazon_PNG2.png"></a>
			</div>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userHome.jsp"><img style = "height : 30px"alt="Amazon logo" src="./images/amazon_PNG2.png"></a>
			</div>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="adminViewProduct.jsp"><img style = "height : 30px"alt="Amazon logo" src="./images/amazon_PNG2.png"></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
