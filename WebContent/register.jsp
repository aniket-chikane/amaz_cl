...
<body style="background-color: #E6F9E6;">
	...
	<div class="container">
		<div class="row"
			style="margin-top: 70px; margin-left: 2px; margin-right: 2px;">
			<div style = "text-align: center;">
			<img alt="logo_black" src="./images/amazon_PNG6.png" style = "height:50px">
			</div><br>
			<form action="./RegisterSrv" method="post"
				class="col-md-6 col-md-offset-3"
				style="margin-top: 10px;border: 1px solid black; border-radius: 5px;  padding: 50px;">
				
				<div style="font-weight: bold;" class="text-center">
					<h2 style="float: left;width :450px;height : 50px">Create Account</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
